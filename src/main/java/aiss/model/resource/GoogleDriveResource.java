...
//Clase donde implementaremos las operaciones
public class GoogleDriveResource {
	...
	//Nos devuelve el archivo cuya id se le pasa como parametros.
	...
	//Borramos el producto cuya id se le pasa como parametro
